...
function filtrerMessage(msg) {
    ...
    return msg.toLowerCase().split(" ").map(e => interdits.includes(e) ? "*".repeat(e.length) : e).join(" ")
}

console.log(filtrerMessage("Ce joueur est un véritable noob sur ce jeu vidéo. il est nul et idiot"))