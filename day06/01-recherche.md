...
> À compléter avec mes propres mots.
    ...
    - (`objet["propriete"]`) peux acceder au variable
    - (`objet.propriete`) chechrche literalement l'attribute
...
> À compléter avec mes propres mots.
    ...
    obj.hello = hello ; obj["hello"] = "hello"
...
> À compléter avec mes propres mots.
    ...
    - this c'est l'object qui appelle la fonciton
...
> À compléter avec mes propres mots.
     ...
     - JSON c'est un object qui contient des key, value
     - l'object classique peux contient encore des fonction
